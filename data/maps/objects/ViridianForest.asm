ViridianForest_Object:
	...
	object_event 25, 11, SPRITE_POKE_BALL, STAY, NONE, 7, SUPER_POTION
	object_event 12, 29, SPRITE_POKE_BALL, STAY, NONE, 8, FULL_HEAL
	object_event  1, 31, SPRITE_POKE_BALL, STAY, NONE, 9, GREAT_BALL

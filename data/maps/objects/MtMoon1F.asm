MtMoon1F_Object:
	...
	object_event  2, 20, SPRITE_POKE_BALL, STAY, NONE, 8, ESCAPE_ROPE
	object_event  2,  2, SPRITE_POKE_BALL, STAY, NONE, 9, MOON_STONE
	object_event 35, 31, SPRITE_POKE_BALL, STAY, NONE, 10, SUPER_POTION
	object_event 36, 23, SPRITE_POKE_BALL, STAY, NONE, 11, RARE_CANDY
	object_event 20, 33, SPRITE_POKE_BALL, STAY, NONE, 12, SUPER_REPEL

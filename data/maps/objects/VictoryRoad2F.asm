VictoryRoad2F_Object:
	...
	object_event 11,  5, SPRITE_BIRD, STAY, UP, 6, MOLTRES, 60
	object_event 27,  5, SPRITE_POKE_BALL, STAY, NONE, 7, TM_SUBMISSION
	object_event 18,  9, SPRITE_POKE_BALL, STAY, NONE, 8, MAX_ELIXER
	object_event  9, 11, SPRITE_POKE_BALL, STAY, NONE, 9, TM_MEGA_KICK
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 10, FULL_RESTORE

SafariZoneEast_Object:
	...
	def_object_events
	object_event 21, 10, SPRITE_POKE_BALL, STAY, NONE, 1, MAX_REPEL
	object_event  3,  7, SPRITE_POKE_BALL, STAY, NONE, 2, MAX_REPEL
	object_event 20, 13, SPRITE_POKE_BALL, STAY, NONE, 3, MAX_REPEL

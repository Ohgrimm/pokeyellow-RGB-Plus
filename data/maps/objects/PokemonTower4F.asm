PokemonTower4F_Object:
	...
	object_event 12, 10, SPRITE_POKE_BALL, STAY, NONE, 4, FULL_RESTORE
	object_event  9, 10, SPRITE_POKE_BALL, STAY, NONE, 5, MAX_ELIXER
	object_event 12, 16, SPRITE_POKE_BALL, STAY, NONE, 6, RARE_CANDY

CeruleanCave2F_Object:
	...
	def_object_events
	object_event  0, 11, SPRITE_POKE_BALL, STAY, NONE, 1, HELIX_FOSSIL
	object_event 16,  7, SPRITE_POKE_BALL, STAY, NONE, 2, DOME_FOSSIL
	object_event 19, 11, SPRITE_POKE_BALL, STAY, NONE, 3, HELIX_FOSSIL
	object_event 27,  9, SPRITE_POKE_BALL, STAY, NONE, 4, DOME_FOSSIL

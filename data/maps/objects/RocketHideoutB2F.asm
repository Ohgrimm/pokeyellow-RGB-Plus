RocketHideoutB2F_Object:
	...
	object_event  1, 11, SPRITE_POKE_BALL, STAY, NONE, 2, FULL_RESTORE
	object_event 16,  8, SPRITE_POKE_BALL, STAY, NONE, 3, MAX_ELIXER
	object_event  6, 12, SPRITE_POKE_BALL, STAY, NONE, 4, TM_HORN_DRILL
	object_event  3, 21, SPRITE_POKE_BALL, STAY, NONE, 5, RARE_CANDY

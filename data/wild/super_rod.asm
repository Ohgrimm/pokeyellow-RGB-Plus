SuperRodFishingSlots::
	...
	db SAFARI_ZONE_CENTER, MAGIKARP, 15, GYARADOS, 25, DRATINI, 10, DRAGONAIR, 30
	db SAFARI_ZONE_EAST, MAGIKARP, 15, GYARADOS, 25, DRATINI, 20, DRAGONAIR, 40
	db SAFARI_ZONE_NORTH, MAGIKARP, 15, GYARADOS, 25, DRATINI, 30, DRAGONAIR, 50
	db SAFARI_ZONE_WEST, MAGIKARP, 15, GYARADOS, 25, DRATINI, 40, DRAGONAIR, 60

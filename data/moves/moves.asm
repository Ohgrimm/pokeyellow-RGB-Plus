...
; Characteristics of each move.
	...
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, STEEL,         85, 15
	...
	move RAZOR_WIND,   FLINCH_SIDE_EFFECT2,         80, FLYING,       100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 20
	move CUT,          NO_ADDITIONAL_EFFECT,        75, NORMAL,        95, 15
	...
	move HORN_DRILL,   OHKO_EFFECT,                  1, STEEL,        30,  5
	...
	move THRASH,       THRASH_PETAL_DANCE_EFFECT,  120, DARK,         100, 20
	...
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, STEEL,        100, 20
	move SUBMISSION,   NO_ADDITIONAL_EFFECT,        80, FIGHTING,      80, 25
	move LOW_KICK,     FLINCH_SIDE_EFFECT2,         60, FIGHTING,     100, 20
	move COUNTER,      NO_ADDITIONAL_EFFECT,         1, FIGHTING,     100, 20
	move SEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        1, FIGHTING,     100, 20
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        90, FIGHTING,     100, 10
	...
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 15
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      40, WATER,        100, 30
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, FIGHTING,     100, 10
	...
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 20
	move TRI_ATTACK,   CONFUSION_SIDE_EFFECT,        80, NORMAL,      100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,        90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        75, DARK,          95, 15
	move SUBSTITUTE,   SUBSTITUTE_EFFECT,            0, NORMAL,       100, 20
	move STRUGGLE,     RECOIL_EFFECT,               50, NORMAL,       100, 20

...
MistyData:
	db 25, SLOWBRO, TENTACRUEL, GOLDUCK, BLASTOISE, VAPOREON, STARMIE, 0
...
KogaData:
	db 50, ARBOK, WEEZING, MUK, VENOMOTH, GOLBAT, 0

BlaineData:
	db 55, FLAREON, MAGMAR, NINETALES, RAPIDASH, ARCANINE, CHARIZARD, 0
...
LoreleiData:
	db $FF, 65, DEWGONG, CLOYSTER, JYNX, CLOYSTER, JYNX, LAPRAS, 0
...
AgathaData:
	db 65, GASTLY, HAUNTER, GENGAR, GENGAR, GENGAR, GENGAR, 0

LanceData:
	db $FF, 70, GYARADOS, 70, ARBOK, 70, AERODACTYL, 70, CHARIZARD, 70, SEADRA, 75, DRAGONITE, 0

...
Rival1Data:
	db 5, EEVEE, 0
; Route 22
	db 10, SPEAROW, EEVEE, 0
; Cerulean City
	db 20, SPEAROW, SANDSHREW, RATTATA, EEVEE, 0
...
BrunoData:
	db 70, PRIMEAPE, HITMONCHAN, HITMONLEE, POLIWRATH, MACHAMP, 0

BrockData:
	db 20, GEODUDE, ONIX, 0

MistyData:
	db 25, HORSEA, GOLDEEN, PSYDUCK, WARTORTLE, VAPOREON, STARMIE, 0
...
Rival2Data:
; SS Anne 2F
	db 25, PIDGEOTTO, MANKEY, NIDORINO, SANDSLASH, EEVEE, 0
; Pokémon Tower 2F
	db 30, FEAROW, SHELLDER, VULPIX, SANDSHREW, EEVEE, 0
	db 30, FEAROW, MAGNEMITE, SHELLDER, SANDSHREW, EEVEE, 0
	db 30, FEAROW, VULPIX, MAGNEMITE, SANDSHREW, EEVEE, 0
; Silph Co. 7F
	db 45, SANDSLASH, NINETALES, CLOYSTER, KADABRA, JOLTEON, 0
	db 45, SANDSLASH, CLOYSTER, MAGNETON, KADABRA, FLAREON, 0
	db 45, SANDSLASH, MAGNETON, NINETALES, KADABRA, VAPOREON, 0
; Route 22
...
LoreleiData:
	db 70, DEWGONG, CLOYSTER, JYNX, LAPRAS, 0
...
LanceData:
	db 75, GYARADOS, ARBOK, AERODACTYL, CHARIZARD, SEADRA, DRAGONITE, 0

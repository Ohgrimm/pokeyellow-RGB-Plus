...
ViridianCashierText::
	script_mart POKE_BALL, POTION, ANTIDOTE, AWAKENING, BURN_HEAL, ICE_HEAL, ETHER, PARLYZ_HEAL, REPEL, ESCAPE_ROPE
...
IndigoCashierText::
	script_mart FULL_RESTORE, MAX_POTION, FULL_HEAL, MAX_REVIVE, MAX_ELIXER
